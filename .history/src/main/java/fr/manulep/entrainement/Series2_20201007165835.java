...
public class Series2 {
	...
	public static List<String> sortByLastLetter(List<String> names) {
		Collections.sort(names, (d1, d2) -> {
			char d2letter = d2.charAt(d2.length() - 1);
			char d1letter = d1.charAt(d1.length() - 1);
			return d2letter - d1letter;
		});
		return names;
	}
